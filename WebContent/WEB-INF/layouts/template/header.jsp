...
<nav class="navbar navbar-toggleable-md navbar-expand-md py-0">
	...
	<div class="navbar-collapse collapse" id="navbarNav">
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/companyLogin/login">Company</a></li>
			...
			<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/companyLogin/home">Profile</a></li>
			</c:if>
			
			<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/product/flights">Flights</a></li>
		
			<!-- Logged in at all -->
			<c:if test="${not empty token or not empty companyToken }">
